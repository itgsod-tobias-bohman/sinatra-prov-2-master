class Seeder
  ...
  def self.showings
    ...
    Showing.create(movie_id: 3, cinema: cinema, room: cinema.rooms.first, start_time: DateTime.strptime('2015-03-13 21:15', '%Y-%m-%d %H:%M') )
    Showing.create(movie_id: 3, cinema: cinema, room: cinema.rooms.first, start_time: DateTime.strptime('2015-03-14 21:15', '%Y-%m-%d %H:%M') )
    Showing.create(movie_id: 3, cinema: cinema, room: cinema.rooms.first, start_time: DateTime.strptime('2015-03-15 21:15', '%Y-%m-%d %H:%M') )
    Showing.create(movie_id: 3, cinema: cinema, room: cinema.rooms.first, start_time: DateTime.strptime('2015-03-16 21:15', '%Y-%m-%d %H:%M') )
    Showing.create(movie_id: 3, cinema: cinema, room: cinema.rooms.first, start_time: DateTime.strptime('2015-03-17 21:15', '%Y-%m-%d %H:%M') )
